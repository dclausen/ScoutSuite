...
from ScoutSuite.providers.gsuite.services import GsuiteServicesConfig

class GsuiteProvider(BaseProvider):
    """
    ...
    def __init__(self, report_dir=None, timestamp=None,
        ...
        self.provider_code = 'gsuite'
        self.provider_name = 'GSuite'
        self.environment = None
        self.account_id = None
        self.services_config = GsuiteServicesConfig

        super(GsuiteProvider, self).__init__(report_dir, timestamp, services, skipped_services)
